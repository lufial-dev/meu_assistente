...
import 'package:meu_assistent/models/chat_message.dart';
import 'package:meu_assistent/widgets/chat_message_list_item.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  void initSpeechRecognizer() {
    ...
    _speechRecognition.setRecognitionResultHandler(
      (String speech) => setState(() => _controllerText.text = speech),
    );
  ...
  void _sendMessage({String text}) {
    ...
    _addMessage(name: 'Filipe Alves', text: text, type: ChatMessageType.sent);
  }
  ...
  Widget _buildRecordButton() {
    return new Container(
      margin: new EdgeInsets.only(left: 8.0),
      child: new IconButton(
        icon: new Icon(Icons.mic, color: Theme.of(context).accentColor),
        onPressed: () {
